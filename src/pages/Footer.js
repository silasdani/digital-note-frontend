...
function Footer() {
  return (
    <footer className="text-center lg:text-left bg-primary text-gray-600">
      ...
      <div className="text-center p-6 bg-yellow-400">
        <span>© {Date.t} Copyright: </span>
        <a className="text-gray-600 font-semibold" href="https://tailwind-elements.com/">All rights reserved</a>
      </div>
    </footer>
  )
}
