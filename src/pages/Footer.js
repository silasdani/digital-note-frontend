...
function Footer() {
  return (
    <footer class="text-center lg:text-left bg-primary text-gray-600">
      ...
      <div class="text-center p-6 bg-yellow-400">
        <span>© 2022 Copyright: </span>
        <a class="text-gray-600 font-semibold" href="https://tailwind-elements.com/">All rights reserved</a>
      </div>
    </footer>
  )
}
