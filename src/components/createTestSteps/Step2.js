    ...
    <div className="Student Workspace">
      <div className="mockup-window bg-primary shadow-md text-center">
        ...
        <div className="px-4 border-t border-base-300 bg-white min-h-[50vh]">
          ...
          {examen.examType !== 'digital' ? <p className="py-2">There would not be a desired workspace for students due the type of exam is not digital</p> : <>
            ...
            <div className="italic text-sm">The student is given an area to resolve the form.</div>
          </>}
        </div>
      </div>
    </div >
