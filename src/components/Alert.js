...
const Alert = ({ type, message, leftButtonText, rightButtonText, delay, ...props }) => {
  ...
  return (
    <div className="fixed mt-[90vh] ml-10 z-40">
      {type == 0 && (
        <div className="alert alert-info bg-primary text-white shadow-lg">
          <div>
            <svg
      ...
      {type == 4 && (
        <div className="alert shadow-lg">
          ...
          <div className="flex-none">
            <button className="btn btn-sm btn-ghost" onClick={props.leftFunction}>
              {leftButtonText || 'Deny'}
            </button>
            <button className="btn btn-sm btn-primary" onClick={props.rightFunction}>
