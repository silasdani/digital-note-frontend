  ...
  switch (action.type) {
    ...
    case userActions.USER_CREATED:
      return alertShown({
        ...
        message: 'Successfully created teacher, Welcome !',
      });
    ...
    case examActions.INVALID_ACCESS_KEY:
      return alertShown({
        type: ALERT_TYPES.error,
        message: 'Your access key is invalid - Please try again.',
      });
    ...
    default:
      return alertShown({ type: ALERT_TYPES.success, message: 'Success!' });
  }
};
